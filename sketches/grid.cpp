...
int main(int argc, char **argv)
{
    ...
    if (!vm.count("output") || !vm.count("landmarks"))
    {
        cout << desc << endl;
    ...
    cnpy::npz_t my_npz = cnpy::npz_load("resnet50-pretrained-np-dump.npz");
    ...
    // store the uncompressed vectors to npz
    ...
    cnpy::npz_save("resnet50-grid-dump.npz","qstq",sketches,"w"); //"a" appends to the file we created above
    cout << "done" << endl;
    return 0;
}
